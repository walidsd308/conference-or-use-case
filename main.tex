...
Operating room (OR) scheduling is a complex, multi-objective optimization problem directly impacting healthcare delivery, operational costs, and patient outcomes. While conventional approaches prioritize operational metrics through deterministic or stochastic models, they typically impose predetermined schedules without incorporating patient preferences, treating patients as passive participants rather than stakeholders. This operational-centric perspective overlooks the human dimension of surgical care, including patient anxiety, schedule disruption costs, and the therapeutic value of patient involvement in treatment planning.
