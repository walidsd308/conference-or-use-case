...
The computational experiments use data from the Department of Orthopedic Surgery at the University Hospital of Montpellier for elective surgical procedures over a three-week period. This framework is used to test the model's ability to optimize and condense the pre-existing surgical schedule.
