...
Patients with higher availability scores $\sigma_p$ are prioritized in the selection sequence. After each patient confirms a selection, slot availability is updated and scores are recomputed for remaining patients, as detailed in Algorithm \ref{alg:patient_ordering}.
